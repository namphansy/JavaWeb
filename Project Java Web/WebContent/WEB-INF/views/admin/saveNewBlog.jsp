...
<title>Thêm bài viết mới | Quản trị</title>
...
<link href="<c:url value="/resources/js/summernote/summernote-bs4.min.css" />"
	rel="stylesheet">	
...
<body class="nav-md">
				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="x_panel">
								<div class="x_content">
									<f:form action="saveBlog.htm"  modelAttribute="newBlog" method="post" id="formSave">
										<span class="section">Thêm bài viết mới</span>
	...
	<script
		...
		type="text/javascript"></script>
	<script src="<c:url value="/resources/js/summernote/summernote-bs4.min.js"/>"
		type="text/javascript"></script>	
