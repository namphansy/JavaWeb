										...
										<div class="col-sm-12">
											<div class="card-box table-responsive">
												<button class="btn-add-product">
													<a href="adminInitInsertCategories.htm">Thêm danh mục mới</a> 
												</button>
												<table id="datatable"
													...
													<tbody>
														<c:forEach items="${listCategories}" var="cat">
															<tr>
																...
																<td><a href="adminInitUpdateCategories.htm?catalogId=${cat.catalogId}" title="cập nhật">
