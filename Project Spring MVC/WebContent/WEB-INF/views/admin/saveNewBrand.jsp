...
<title>Thêm thương hiệu mới | Quản trị</title>
				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="x_panel">
								<div class="x_content">
									<f:form action="InsertBrand.htm"  modelAttribute="newBrand" method="post" id="formSave">
										<span class="section">Thêm thương hiệu mới</span>
										<div class="field item form-group">
											<label class="col-form-label col-md-3 col-sm-3  label-align">Tên thương hiệu<span
												class="required">*</span></label>
											<div class="col-md-6 col-sm-6">
												<f:input class="form-control" path="brandName" name="brandName"/>
											</div>
										</div>
										<div class="field item form-group">
