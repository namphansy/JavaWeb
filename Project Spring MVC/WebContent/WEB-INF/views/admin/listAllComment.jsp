...
<title>Bình luận | Quản trị</title>
												...
												<table id="datatable"
													...
													<tbody>
														<c:forEach items="${listComment}" var="cmt">
															<tr>
																<td>${cmt.commentId}</td>
																<td>${cmt.productsComment.productId}</td>
																<td>${cmt.webUserComment.userId}</td>
																<td>
																	<fmt:formatDate value="${cmt.created}" pattern="yyyy/MM/dd" />
																</td>
																<td><c:choose>
																		<c:when test="${cmt.commentStatus}">Active</c:when>
																		<c:otherwise>Inactive</c:otherwise>
																	</c:choose></td>
																<td>
  																	<a href="removeComment.htm?commentId=${cmt.blogId}">
  																		<i class="far fa-edit"></i>
  																	</a>
  																	<a href="updateStatusComment.htm?commentId=${cmt.blogId}">
