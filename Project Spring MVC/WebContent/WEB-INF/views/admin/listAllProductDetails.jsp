										...
										<div class="col-sm-12">
											<div class="card-box table-responsive">
												...
												<table id="datatable"
													...
													<tbody>
														<c:forEach items="${listProductDetails}"
															var="proDetails">
															<tr>
																<td>${proDetails.productsDetailsId}</td>
																<td>${proDetails.products.productName}</td>
																<td>${proDetails.sizeProduct.sizeName}</td>
																<td><c:choose>
																		<c:when test="${proDetails.productsDetailsStatus}">
																...
																<td><a
																	href="adminInitUpdateProductDetails?productDetailsId=${proDetails.productsDetailsId}"
																	title="cập nhật"> <i class="far fa-edit"></i>
																</a></td>
															</tr>
														</c:forEach>
													</tbody>
